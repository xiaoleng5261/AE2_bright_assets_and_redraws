...
# Main changes: 
  ...
  2. 2. The network tool card slot package is adapted to the GUI of all work blocks as much as possible (a large number of texture packs have not completed this work).
  3. Redraw AE2Ad ditions material is a highlight style material.
